/*
Author: Anton Ilic
Solution for: https://www.hackerrank.com/challenges/30-operators/problem
Dec. 2nd, 2022
...
void solve(double meal_cost, int tip_percent, int tax_percent) {
    //tip is not on top of tax
    meal_cost = int(meal_cost + meal_cost * tax_percent/100 + meal_cost * tip_percent/100);
    cout << meal_cost << endl;
